function handle=custombar(loc,barlimits)
%CUSTOMBAR Display color bar (color scale).
%   CUSTOMBAR('vert',barlimits) appends a vertical color scale to the current
%   axis. COLORBAR('horiz',barlimits) appends a horizontal color scale.
%
%   CUSTOMBAR(H) places the colorbar in the axes H. The colorbar will
